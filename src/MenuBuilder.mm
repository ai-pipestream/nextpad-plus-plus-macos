...
+ (void)buildMainMenu {
    ...
    // ⌥⌘I — pairs with ⌘I the way ⇧⌘F pairs with ⌘F: modifier means "another
    // variant of the same idea". Feature soft-requires macOS 14 (the action
    // shows an explanatory alert on older systems).
